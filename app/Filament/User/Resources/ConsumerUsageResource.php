...
use App\Filament\User\Resources\ConsumerUsageResource\Pages;
use App\Filament\User\Resources\ConsumerUsageResource\RelationManagers;
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('Usage Information')
                    ->description('Record consumer equipment usage details')
                    ->schema([
