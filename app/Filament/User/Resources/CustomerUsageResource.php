...
use App\Filament\User\Resources\CustomerUsageResource\Pages;
use App\Filament\User\Resources\CustomerUsageResource\RelationManagers;
...
class CustomerUsageResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Add Usage Record';
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('Usage Information')
                    ->description('Record customer equipment usage details')
                    ->schema([
